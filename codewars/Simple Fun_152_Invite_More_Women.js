// King Arthur and his knights are having a New Years party. Last year Lancelot was 
// jealous of Arthur, because Arthur had a date and Lancelot did not, and they started
// a duel.
// To prevent this from happening again, Arthur wants to make sure that there 
// are at least as many women as men at this year's party. He gave you a list of
...
console.log(inviteMoreWomen(arr));
console.log(inviteMoreWomen(arr2));
console.log(inviteMoreWomen(arr3));
